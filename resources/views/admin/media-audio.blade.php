		...
		<div class="flex justify-around gap-x-10">
			...
			<div class="">
				...
				<div class="flex flex-col items-center cursor-pointer" x-data="{}" @click="$refs.file.click()">
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#bb0000"  width="60">
			...
			<div class="">
				<div class="">Моно звук</div>
	
				<div class="flex flex-col items-center cursor-pointer" x-data="{}" @click="$refs.file.click()">
					<input type="file" name="" class="hidden" x-ref="file" accept="video/*">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#009900" width="60">
