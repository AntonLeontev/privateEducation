...
<li class="relative" x-data="{submenu: false}" @mouseover="submenu = true" @mouseout="submenu = false">
	...
	<ul 
		class="absolute bg-[#344760] rounded top-[calc(1.2vw+1rem)] [&>*:nth-child(n)]:!ml-0 flex flex-col gap-y-3 whitespace-nowrap transition text-[1.2vw] shadow-md shadow-gray-800"
		x-show="submenu"
		style="display: none"
	>
		{{ $slot }}
